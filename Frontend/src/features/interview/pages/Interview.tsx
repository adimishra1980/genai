...
import { useInterview } from "../hooks/useInterview.tsx";

import QuestionCard from "../components/QuestionCard.tsx";
import RoadMapDay from "../components/RoadMapDay.tsx";
import { NAV_ITEMS } from "../constants/navItems.tsx";
    ...
    return (
      <div className="interview-error">
        <div className="interview-error__content">
          <h2>Failed to Load Interview Plan</h2>
          <p>{error}</p>
          <button
    ...
    return (
      <div className="interview-error">
        <div className="interview-error__content">
          ...
          <p>The requested interview plan could not be found.</p>
          <button
            className="button primary-button"
            onClick={() => navigate("/")}
          >
            ...
            <section>
              ...
              <div className="roadmap-list">
                {report.preparationPlan.map((plan) => (
                  <RoadMapDay key={plan._id} plan={plan} />
                ))}
              </div>
            </section>
          )}
